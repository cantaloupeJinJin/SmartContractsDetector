...
with tf.Session() as sess:
    ...
    new_saver = tf.train.import_meta_graph('differentmodels/600model/mymodel-400.meta')
    new_saver.restore(sess, tf.train.latest_checkpoint('differentmodels/600model'))
    print("inference....")
